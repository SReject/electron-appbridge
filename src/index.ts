    ...
    const bridge: MainAppBridge = Object.create(null, {
        ...
        hook: {
            ...
            value: (
                ...
                const hookedInvoke: AppBridgeInvoke = (
                    reply,
                    path,
                    context,
                    args
                    ...
                    for (let idx = 0; idx < 64; idx += 1) {
                        const charCode =
                            Math.floor(Math.random() * (126 - 32)) + 33;
                        id += String.fromCharCode(charCode);
                    }
                    const handler = (
                        ignore: Electron.IpcMainEvent,
                        data: AppBridgeResponse
                    ) => {
                    ...
                    browserWindow.webContents.send("AppBridge:Invoke", {
                        id,
                        path,
                        context,
                        args,
        ...
        unhook: {
            ...
            value: () => {
                ...
                if (hookedWindow) {
                    ...
                    hookedWindow.webContents.ipc.removeAllListeners(
                        "AppBridge:Emit"
                    );
                    hookedWindow.webContents.ipc.removeAllListeners(
                        "AppBridge:Invoke"
